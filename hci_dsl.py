"""
Simple hci DSL translator.

This module provides a tiny domain specific language used in conf.py files to
describe a hci platform and emit a Lua configuration (conf.lua). The DSL is
intentionally small: construct a hciPlatform, add modules (CPU, DRAM,
